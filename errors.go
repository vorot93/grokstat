...
var (
	...
	NoConfig           = errors.New("No config file specified.")
	ErrorLoadingConfig = errors.New("Error loading config file.")
	...
	InvalidResponseHeader    = errors.New("Invalid response header.")
