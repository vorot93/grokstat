...
func MakeProtocolMap(configData []ProtocolConfig) map[string]models.ProtocolEntry {
	...
	templates["Q3S"] = models.ProtocolEntry{Base: models.ProtocolEntryBase{IsMaster: false, MakeRequestPacketFunc: q3s.MakeRequestPacket, ResponseParseFunc: q3s.ParseResponse, HttpProtocol: "udp", ResponseType: "Server info"}, Information: models.ProtocolEntryInfo{"Name": "Quake III Arena", "PreludeStarter": "\xFF\xFF\xFF\xFF", "Challenge": "GrokStat_" + string(time.Now().Unix()), "RequestPreludeTemplate": "{{.PreludeStarter}}getinfo {{.Challenge}}\n", "ResponsePreludeTemplate": "{{.PreludeStarter}}infoResponse", "Version": "68", "DefaultRequestPort": "27950"}}
